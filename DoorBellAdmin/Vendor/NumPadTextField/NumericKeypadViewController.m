...
- (void)viewDidLoad {
	...
	[self.saveButton setTitle:NSLocalizedString(@"", @"Title for save button on numeric keypad") forState:UIControlStateNormal];
	
	NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
	[self.decimalButton setTitle:formatter.plusSign forState:UIControlStateNormal];
}
